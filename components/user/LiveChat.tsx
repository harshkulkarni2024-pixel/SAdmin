...
const LiveChat: React.FC<LiveChatProps> = ({ user }) => {
    ...
    const startConversation = async () => {
        ...
        try {
            ...
            const systemInstruction = `You are "Item", a friendly AI expert for an Instagram content creator named ${userName}. Their bio is: "${user.about_info || 'اطلاعاتی ثبت نشده'}". You must speak Persian. Start the conversation with a friendly greeting like "سلام ${userName} جان، چطور میتونم کمکت کنم؟".`;
