            ...
            sessionPromiseRef.current = ai.live.connect({
                ...
                callbacks: {
                    ...
                    onmessage: async (message: LiveServerMessage) => {
                        if (message.error) {
                            console.error('Live chat message error:', message.error);
                            const errorMessage = message.error.message || 'An unknown error occurred in the stream.';
                            setError(`خطا در حین گفتگو: ${errorMessage}`);
                            return;
                        }
