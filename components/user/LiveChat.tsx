        ...
        try {
            ...
            const sessionPromise = ai.live.connect({
                ...
                config: {
                    ...
                    systemInstruction: `You are "Item", a friendly AI for an Instagram content creator named ${user.full_name}. Here is some info about them: ${user.about_info}. You must speak Persian.`,
                },
            });
