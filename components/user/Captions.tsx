...
const Captions: React.FC<CaptionsProps> = ({ user, onUserUpdate }) => {
  ...
  const handleGenerateFromIdea = async () => {
    ...
    if (user.caption_idea_requests >= 2) {
  ...
  const isLimitReached = user.caption_idea_requests >= 2;
    ...
    <div className="animate-fade-in">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-slate-800 p-6 rounded-lg border border-slate-700 mb-8">
            ...
            <p className="text-sm text-slate-400 mb-4">محدودیت روزانه: {user.caption_idea_requests} / 2</p>
