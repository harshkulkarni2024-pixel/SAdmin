...
const Captions: React.FC<CaptionsProps> = () => {
  ...
  const handleGenerateFromIdea = async () => {
    ...
    if ((user.caption_idea_requests ?? 0) >= dailyLimit) {
  ...
  const isLimitReached = (user.caption_idea_requests ?? 0) >= dailyLimit;
    ...
    <div className="animate-fade-in">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-slate-800 p-6 rounded-lg border border-slate-700 mb-8">
            ...
            <p className="text-sm text-slate-400 mb-4">محدودیت روزانه: {user.caption_idea_requests ?? 0} / {dailyLimit}</p>
                ...
                <div className="space-y-4">
                    ...
                    <div className="relative">
                        ...
                        <textarea
                            ...
                            className="w-full h-24 p-4 pr-12 bg-slate-900 border border-slate-700 rounded-lg text-white placeholder-slate-500 focus:ring-2 focus:ring-violet-500 focus:outline-none resize-none"
