        ...
        <div className="h-full flex flex-col max-w-4xl mx-auto animate-fade-in">
            <div className="text-center mb-4">
                 <div className="flex items-center justify-center gap-4">
                    ...
                    <button onClick={() => setActiveView('live_chat')} className="flex items-center gap-2 px-3 py-1.5 text-sm bg-slate-700 text-slate-300 rounded-full hover:bg-violet-600 hover:text-white transition-colors" title="رفتن به گفتگوی زنده">
                        <Icon name="phone-wave" className="w-4 h-4" />
                        <span>زنده</span>
                    </button>
                 </div>
                 ...
                 <div className="flex items-end gap-2">
                    <div className="relative flex-1">
                        <textarea
                            ...
                            className="w-full pl-28 pr-4 py-3 bg-slate-800 border border-slate-700 rounded-lg text-white focus:ring-2 focus:ring-violet-500 focus:outline-none resize-none overflow-y-auto max-h-48"
