            ...
            <div className="flex items-center gap-2">
                ...
                <div className="relative flex-1">
                    <textarea
                        ...
                        className="w-full pl-4 pr-24 py-3 bg-slate-800 border border-slate-700 rounded-lg text-white focus:ring-2 focus:ring-violet-500 focus:outline-none resize-none overflow-y-auto max-h-48"
