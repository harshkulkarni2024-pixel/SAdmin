...
const FreeChat: React.FC<FreeChatProps> = ({ setActiveView }) => {
    ...
    return (
        <div className="h-full flex flex-col max-w-4xl mx-auto animate-fade-in">
            ...
            <button onClick={() => setActiveView('live_chat')} className="w-full flex items-center justify-center gap-3 px-4 py-3 mb-4 bg-slate-700 text-white font-semibold rounded-lg hover:bg-slate-600 transition-colors opacity-70">
                <div className="flex items-center justify-center gap-2">
                    <span className="font-bold text-white">LIVE</span>
                    <span>گفتگوی زنده (بزودی)</span>
                </div>
            </button>
                 ...
                 <div className="flex items-end gap-2">
                    ...
                    <div className="relative flex-1">
                        <textarea
                            ...
                            className="w-full pr-12 pl-4 py-3 bg-slate-800 border border-slate-700 rounded-lg text-white focus:ring-2 focus:ring-violet-500 focus:outline-none resize-none overflow-y-auto max-h-48"
