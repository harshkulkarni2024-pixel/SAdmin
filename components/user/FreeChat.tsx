...
const FreeChat: React.FC<FreeChatProps> = () => {
                 ...
                 <div className="flex items-end gap-2">
                    <div className="relative flex-1">
                        <textarea
                            ...
                            className="w-full pl-4 pr-4 py-3 pb-14 bg-slate-800 border border-slate-700 rounded-lg text-white focus:ring-2 focus:ring-violet-500 focus:outline-none resize-none overflow-y-auto max-h-48"
