...
import { generateStoryScenario, StorySlide, handleGeminiError } from '../../services/geminiService';
...
const StoryGenerator: React.FC<StoryGeneratorProps> = () => {
    ...
    const [currentScenario, setCurrentScenario] = useState<StorySlide[] | null>(null);
    ...
    const handleGenerate = async () => {
        ...
        try {
            ...
            const friendlyError = handleGeminiError(e);
    ...
    const renderScenarioSlides = (slides: StorySlide[]) => {
