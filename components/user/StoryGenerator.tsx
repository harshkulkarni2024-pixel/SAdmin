                    ...
                    <div>
                        ...
                        <div className="relative">
                            <textarea
                                ...
                                className="w-full h-24 p-4 pr-14 bg-slate-800 border border-slate-700 rounded-lg text-white placeholder-slate-500 focus:ring-2 focus:ring-violet-500 focus:outline-none resize-none"
                                disabled={isLoading}
                            />
                        ...
                        <p className="text-xs text-slate-400 mb-2">مثلاً: آنباکسینگ محصول جدید، یک روز از زندگی من، یا پاسخ به سوالات مخاطبان...</p>
                         <div className="relative">
                            ...
                            <textarea
                                ...
                                className="w-full h-32 p-4 pr-20 bg-slate-800 border border-slate-700 rounded-lg text-white placeholder-slate-500 focus:ring-2 focus:ring-violet-500 focus:outline-none resize-none"
                                disabled={isLoading}
                            />
