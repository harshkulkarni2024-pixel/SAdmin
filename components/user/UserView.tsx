  ...
  const renderView = () => {
    switch (activeView) {
      ...
      case 'competitor_analysis':
        return <CompetitorAnalysis user={user} onUserUpdate={onUserUpdate} />;
      case 'story':
       ...
       <header className="flex-shrink-0 bg-slate-900/80 backdrop-blur-lg flex items-center h-20 px-6 border-b border-slate-800 relative">
          ...
          <div className="flex-1 text-center">
           ...
           <div className="absolute left-6 top-1/2 -translate-y-1/2 flex items-center gap-2">
                 <button onClick={() => alert('قابلیت نوتیفیکیشن به زودی اضافه خواهد شد!')} className="p-2 text-slate-300 hover:text-white relative" title="اعلانات">
          ...
          <div className="flex-grow overflow-y-auto">
            <nav className="p-4 mt-4">
              <ul className="space-y-2">
                  ...
                  <NavItem view="live_chat" icon="phone-wave" label="گفتگوی زنده" />
