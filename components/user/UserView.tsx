...
import CompetitorAnalysis from './CompetitorAnalysis'; // New import
...
export type UserViewType = 'dashboard' | 'story' | 'post_scenario' | 'plans' | 'reports' | 'image_video' | 'caption' | 'chat' | 'post_idea' | 'algorithm_news' | 'competitor_analysis';

const VALID_VIEWS: UserViewType[] = ['dashboard', 'story', 'post_scenario', 'plans', 'reports', 'image_video', 'caption', 'chat', 'post_idea', 'algorithm_news', 'competitor_analysis'];
