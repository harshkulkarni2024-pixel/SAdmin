...
const CompetitorAnalysis: React.FC<CompetitorAnalysisProps> = ({ user }) => {
    ...
    const handleAnalyze = async () => {
        ...
        try {
            ...
            setLoadingStep('در حال تحلیل بصری و استخراج آی‌دی از تصویر...');
            ...
            setLoadingStep(`آی‌دی «${instagramId}» شناسایی شد. در حال جستجو در وب...`);
    ...
    return (
        <div className="max-w-4xl mx-auto animate-fade-in">
            <h1 className="text-3xl font-bold text-white mb-2">تحلیل رقیب با اسکرین‌شات</h1>
            <p className="text-slate-400 mb-6">یک اسکرین‌شات از پیج رقیب آپلود کنید تا هوش مصنوعی ظاهر و استراتژی آن را تحلیل کند.</p>
