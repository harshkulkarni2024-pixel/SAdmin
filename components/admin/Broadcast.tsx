            ...
            <div className="space-y-4">
                <div className="relative">
                    <textarea
                        ...
                        className="w-full h-40 p-4 pr-14 bg-slate-800 border border-slate-700 rounded-lg text-white placeholder-slate-500 focus:ring-2 focus:ring-violet-500 focus:outline-none resize-none"
                        disabled={isSending}
                    />
