                ...
                return (
                    <div>
                        ...
                        <div className="mt-4 flex gap-4">
                            ...
                            {content && <button onClick={() => handleDelete(activeTab === 'plans' ? 'plan' : 'report', user.user_id)} className="bg-red-800 px-4 py-2 rounded flex items-center"><Icon name="trash" className="w-4 h-4 me-2"/>حذف</button>}
                        </div>
                    </div>
                );
             case 'subscription':
