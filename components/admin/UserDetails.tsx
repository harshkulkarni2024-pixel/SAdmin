...
لطفاً راهنمای SQL در فایل services/dbService.ts را بررسی کرده و دستورات مربوط به افزودن ستون‌های 'caption_idea_requests' و 'caption_idea_limit' را اجرا کنید.`;
    ...
    const handleInsertReportTemplate = () => {
        const template = `- تعداد کل ویدیو های تحویل داده شده: 0
- تعداد ویدیو بارگذاری شده: 0
- تعداد ویدیو در انتظار بارگزاری: 0
- تعداد ویدیو های در حال تدوین: 0

**توضیحات بیشتر:**
`;
        setNewReportContent(template);
    };
                 ...
                 return (
                    <div>
                        <div className="bg-slate-900/70 p-4 rounded-lg mb-6">
                            ...
                            <div className="relative">
                                <textarea value={newReportContent} onChange={(e) => setNewReportContent(e.target.value)} className="w-full h-40 bg-slate-700 p-2 rounded mb-2" placeholder="محتوای گزارش جدید را اینجا بنویسید..."></textarea>
                            </div>
                            <div className="flex items-center gap-2">
                                ...
                                <button onClick={handleInsertReportTemplate} className="bg-slate-600 px-4 py-2 rounded hover:bg-slate-500">افزودن قالب</button>
                            </div>
                        </div>
                        <div className="space-y-4">
