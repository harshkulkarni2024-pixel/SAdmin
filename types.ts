...
export interface User {
  ...
  is_verified: boolean;
  about_info?: string;
  story_requests: number;        // Daily limit: 2
  caption_idea_requests: number; // Daily limit: 2
  image_requests: number;        // Weekly limit: 35
  chat_messages: number;         // Weekly limit: 150
