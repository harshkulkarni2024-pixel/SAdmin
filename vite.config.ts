...
export default defineConfig({
  plugins: [react()],
  // Change 'base' to an absolute path '/'.
  // This makes the built assets path-dependent on the root of the domain,
  // which is a more robust solution for PWAs and solves the '/assets/' prefix issue.
  base: '/',
